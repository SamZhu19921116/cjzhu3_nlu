...
class BM25(object):
    def __init__(self, do_train=True , save_path=args.sort_bm25_model):
        if do_train:
            self.data = pd.read_csv(args.retrival_hnsw_train_zhongan, sep='\t', header=None,quoting=csv.QUOTE_NONE, names=['question1', 'question2', 'target'])
    ...
    def load_stop_word(self):
        stopwords = open(args.stopwords_data , 'r' , encoding='utf-8').readlines()
